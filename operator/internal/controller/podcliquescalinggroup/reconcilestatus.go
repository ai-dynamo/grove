...
func (r *Reconciler) reconcileStatus(ctx context.Context, logger logr.Logger, pcsgObjectKey client.ObjectKey) ctrlcommon.ReconcileStepResult {
	...
	mutateReplicas(logger, revision, pcs, pcsg, pclqsPerPCSGReplica)
	...
	mutateCurrentPodCliqueSetGenerationHash(logger, revision, pcs, pcsg, lo.Flatten(lo.Values(pclqsPerPCSGReplica)))
...
func mutateReplicas(logger logr.Logger, revision *commonrevision.Revision, pcs *grovecorev1alpha1.PodCliqueSet, pcsg *grovecorev1alpha1.PodCliqueScalingGroup, pclqsPerPCSGReplica map[string][]grovecorev1alpha1.PodClique) {
...
func mutateCurrentPodCliqueSetGenerationHash(logger logr.Logger, revision *commonrevision.Revision, pcs *grovecorev1alpha1.PodCliqueSet, pcsg *grovecorev1alpha1.PodCliqueScalingGroup, existingPCLQs []grovecorev1alpha1.PodClique) {
...
func havePCSGPodCliquesConverged(revision *commonrevision.Revision, pcs *grovecorev1alpha1.PodCliqueSet, pcsg *grovecorev1alpha1.PodCliqueScalingGroup, existingPCLQs []grovecorev1alpha1.PodClique) bool {
	expectedPCLQPodTemplateHashes := componentutils.GetPCLQTemplateHashes(revision, pcs, pcsg)
