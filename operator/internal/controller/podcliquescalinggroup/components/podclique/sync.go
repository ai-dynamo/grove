...
// getExpectedPCLQPodTemplateHashMap returns a map keyed by the fully-qualified PodClique name to the expected pod-template hash for every replica of the given PodCliqueScalingGroup.
