...
func getKindSyncGroups() [][]component.Kind {
	return [][]component.Kind{
		...
		// G2: PodCliqueSetReplica patches the parent PCS status. Keep it isolated so the
		// client cannot decode a status response into pcs while sibling operators read it.
		{
