...
const (
	...
	// LabelPodCliqueScalingGroupPodIndexOffset is a key for a label that sets the first group-wide pod index assigned to a PodClique within a PodCliqueScalingGroup replica.
	LabelPodCliqueScalingGroupPodIndexOffset = "grove.io/podcliquescalinggroup-pod-index-offset"
