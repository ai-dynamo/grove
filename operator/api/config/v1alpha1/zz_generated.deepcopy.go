...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MNNVLConfiguration) DeepCopyInto(out *MNNVLConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MNNVLConfiguration.
func (in *MNNVLConfiguration) DeepCopy() *MNNVLConfiguration {
	if in == nil {
		return nil
	}
	out := new(MNNVLConfiguration)
	in.DeepCopyInto(out)
	return out
}
