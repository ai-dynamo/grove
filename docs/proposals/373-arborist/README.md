...
- [Design Details](#design-details)
  ...
  - [TUI (<code>kubectl grove tui</code>)](#tui-kubectl-grove-tui)
    ...
    - [Error UX](#error-ux)
  - [Topology CLI (<code>kubectl grove topology</code>)](#topology-cli-kubectl-grove-topology)
  - [Diagnostics (<code>kubectl grove diagnostics</code>)](#diagnostics-kubectl-grove-diagnostics)
  ...
  - [Test Plan](#test-plan)
    ...
    - [Scale &amp; Performance Tests (KWOK)](#scale--performance-tests-kwok)
