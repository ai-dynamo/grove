...
| `cliqueNames` _string array_ | CliqueNames is the ordered list of PodClique names that are part of the scaling group.<br />The order determines the group-wide pod indices exposed through the<br />grove.io/podcliquescalinggroup-pod-index Pod label. |  |  |
