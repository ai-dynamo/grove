...
| `cliqueNames` _string array_ | CliqueNames is the ordered list of PodClique names that are part of the scaling group.<br />The order determines the group-wide pod indices exposed through GROVE_PCSG_POD_INDEX. |  |  |
